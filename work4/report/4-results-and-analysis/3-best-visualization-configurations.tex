...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\textwidth]{report/visualizations/pca_n_components=3,kernel=rbf,gamma=0.1,n_clusters=2,max_iterations=100,tolerance=0.001,random_state=4.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\textwidth]{report/visualizations/pca_n_components=2,n_clusters=11,max_iterations=100,tolerance=0.001,random_state=4.png}

...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.45\textwidth]{../data/5_metrics_plots/f_measure_comparison_mushroom.png}
    \includegraphics[width=0.45\textwidth]{../data/5_metrics_plots/f_measure_comparison_vowel.png}

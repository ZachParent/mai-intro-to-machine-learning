...
% The results from the comparison between the project's PCA implementation and the Incremental PCA implementation can be seen in Table \ref{tab:pca-vs-incremental-pca}.    

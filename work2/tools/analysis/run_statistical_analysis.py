...
fig.suptitle(f'P-values vs Number of Samples for Different Models and Sampling Methods for {dataset_name} dataset')
...
fig.suptitle(f'Independent Effects of KNN Model Parameters on F1 Score for {dataset_name} dataset', fontsize=16, fontweight='bold')
...
fig.suptitle(f'Independent Effects of SVM Model Parameters on F1 Score for {dataset_name} dataset', fontsize=16, fontweight='bold')
...
fig.suptitle(f'Interaction Effects of KNN Model Parameters on F1 Score for {dataset_name} dataset', fontsize=20, fontweight='bold')
...
fig.suptitle(f'Ranked Folds Distribution for KNN Models for {dataset_name} dataset', fontsize=20, fontweight='bold')
plt.tight_layout()

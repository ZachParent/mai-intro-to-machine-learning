...
from work2.tools.helper import train_and_evaluate_model
from work2.tools.knn import KNNClassifier
from work2.tools.distance import ManhattanDistance, EuclideanDistance, ChebyshevDistance, MahalanobisDistance
from work2.tools.voting import MajorityClassVote, InverseDistanceWeightedVote, ShepardsWorkVote
from work2.tools.preprocess import preprocess_hepatitis_datasets, load_datasets, preprocess_mushroom_datasets
...
if __name__ == '__main__':
    ...
    for dataset_name in dataset_names:
        ...
        train_path = f'../data/raw/{dataset_name}/*train.arff'
        test_path = f'../data/raw/{dataset_name}/*test.arff'
        ...
        file_path_svm = os.path.join("../data/results", f'svm_{dataset_name}.csv')
        ...
        file_path = os.path.join("../data/results", f'knn_{dataset_name}.csv')

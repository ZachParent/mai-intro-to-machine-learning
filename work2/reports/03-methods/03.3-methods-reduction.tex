...
For the edited approach, we opted for \textbf{Edited Nearest Neighbor with Thresholding (ENNTh)} \cite{wilson1972asymptotic}
...
(\textbf{i.e.}, mushroom \& hepatitis), we used the top ranked kNN model to run each of our selected instance reduction techniques 
to generate reduced versions of our training data, we saved them and 

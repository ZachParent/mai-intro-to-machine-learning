...
\paragraph{Non-normal distribution:} Several models show asymmetric distributions, where the median line is not in the middle of the box.
...
making it ideal for comparing two different classifiers on the same datasets.
...
which compares all configurations simultaneously.

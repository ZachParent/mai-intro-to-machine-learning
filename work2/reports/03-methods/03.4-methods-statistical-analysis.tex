...
where $q_{\alpha}$ is based on the Studentized range statistic, $k$ is the number of classifiers, and $N$ is the number of datasets \cite{Friedman_posthoc}.
...
As seen in the plots in the above figures, we perform linear sampling and top sampling with a variety

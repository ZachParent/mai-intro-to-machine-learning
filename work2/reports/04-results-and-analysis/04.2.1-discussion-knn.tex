...
\autoref{fig:ranked_folds_KNN_mushroom} shows the ranked folds for the k-NN algorithm on the mushroom dataset.
...
\autoref{fig:ranked_folds_KNN_hepatitis} shows the ranked folds for the k-NN algorithm on the hepatitis dataset.
